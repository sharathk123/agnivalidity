...
export const IncentiveEngine: React.FC<IncentiveEngineProps> = ({ baseCost, insight }) => {
    return (
        <div className="bg-slate-900 border border-slate-700/50 p-8 h-full flex flex-col">
            ...
            <div className="space-y-6 flex-1">
                ...
                <div className="pt-8 mt-auto border-t border-slate-800 flex justify-between items-center">
